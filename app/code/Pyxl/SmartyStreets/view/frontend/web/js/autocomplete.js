define(
    ...
    function ($, Component, SmartyStreetsSDK, checkoutData, uiRegistry) {
        // checkoutData me underscore lagaya hai -Sachin ->Done
        'use strict';
        ...
        return Component.extend({
            ...
            initialize: function () {
                ...
                // Add your credentials to a credentials object.          YAHAN CREDENTIALS LE RAHA HAI
                //let autoCompleteCredentials = new SmartyStreetsCore.SharedCredentials('<?php echo $block->getSiteKey() ?>');
                let autoCompleteCredentials = new SmartyStreetsCore.SharedCredentials(this.configData.website_key); // yahan .website_key likha hai
                        ...
                        $(this)
                            .autocomplete({
                                ...
                                select: function (event, ui) {
                                    // event me underscore dala hai -SACHIN -> Done
                ...
                function showResults(response) {
                    ...
                    if (response.result && Array.isArray(response.result)) {
                        addresses = $.map(response.result, function (value, key) {
                            //key me underscore dala hai -SACHIN -> Done
                            return {
                                label: value.text,
                                value: value.text
                            }
            ...
            selectAddress: function (address) {
                ...
                function handleSuccess(response) {
                    response.lookups.map(function(lookup, index) {
                        //index me underscore dala hai -SACHIN
